...
class FlexgenStreamHandler(logging.StreamHandler):
    ...
    def __init__(self, stream=None):  # noqa: ANN001
        ...
        formatter = ErrorPrefixFormatter(
...
class CreateStatePlugin(BasePlugin):
    ...
    def _create_state_endpoint(app: App) -> None:
        ...
        async def create_state(request: Request) -> Response:
            ...
            state_name_to_values: dict[str, dict[str, object]] = await request.json()
            ...
            all_states = [
                cls(parent_state=None, _reflex_internal_init=True, init_substates=False)
                for cls in classes
            ]
